...
define $(package)_set_vars
  $(package)_config_opts=--without-docs --enable-static=yes --enable-shared=no --with-libsodium --disable-perf --disable-curve-keygen --disable-Werror --disable-drafts --enable-option-checking
